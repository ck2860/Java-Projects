...
public class FIRE extends Pokemon{
     ...
     * Since this subclass is always for pokemonType.FIRE. Instead of creating its own states, the keyword, "super" can be used in the constructor in order to
     ...
     * @param name assigns to the pokemonType.FIRE's name
     * @param attack assigns to the pokemonType.FIRE's attack
     * @param health assigns to the pokemonType.HEALTH's attack
     */
     ...
     * If the enemy is the pokemonType.WATER, the pokemon's health would be reduced by twice of the enemy's attack.
     * If the enemy is the pokemonType.GRASS, the pokemon's health would be reduced by 1/2 of the enemy's attack.
