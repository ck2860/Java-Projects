...
public class WATER extends Pokemon{
     ...
     * Since this subclass is always for pokemonType.WATER. Instead of creating its own states, the keyword, "super" can be used in the constructor in order to
     ...
     * @param name assigns to the pokemonType.WATER's name
     * @param attack assigns to the pokemonType.WATER's attack
     * @param health assigns to the pokemonType.WATER's attack
     */
     ...
     * If the enemy is the pokemonType.FIRE, the pokemon's health would be deducted by 1/2 of the enemy's attack.
     * If the enemy is the pokemonType.WATER, the pokemon's health would be reduced by the enemy's attack.
     * If the enemy is the pokemonType.GRASS, the pokemon's health would be reduced by twice of the enemy's attack.
