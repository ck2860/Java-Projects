...
public class ShapeMover {
    ...
    /**
     * the function is for showing you the sizes.
     * @param factor the factor to change the scale.
     */
    public static void scaleShape(Figure shape, double factor) {
     ...
     */
    public static void printShape(Figure shape) {
...
//        Shape shape = new Shape(new Position(100, 100), "Red", "Blue"); // cannot be instantiated bc it is an abstract class now
