 ...
 */
public class Integer_Division extends AbstractOperation {
    /**
     * The constructor for the integer division operation that takes a String operator.
     * @param operator String operator should be "//"
     */
    public Integer_Division(String operator){
        super(operator);
    }
    /**
...
//                    System.out.println("Cannot be divided by 0");
            ...
            return (int) result; //rounds down.
        }
    }
}
// end of Integer Division Java class.