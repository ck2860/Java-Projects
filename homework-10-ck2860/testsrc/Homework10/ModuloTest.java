...
class ModuloTest {
    ...
    public void operationSingle(){
        AbstractOperation op = new Modulo("%");
    ...
    public void operationDoubles() {
        ...
        double [] input = {4.0d, 2.0d};
        double expected = 0.0d;

        double [] input1 = {8.0d, 3.0d};
