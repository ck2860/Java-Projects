...
class DivisionTest {
    ...
    public void operationSingle(){
        AbstractOperation op = new Division("/");
    ...
    public void operationZeroes(){
        AbstractOperation op = new Division("/");
        String inputOperator = op.getOperator();
...
//        double [] input = {0.0d};
    ...
    public void operationMultiples(){
        ...
        double [] input = {5.5d, 5.0d, 10.5d};
        double expected = 0.10476190476190476d;
    ...
    public void operationNegative(){
        //set up
        AbstractOperation op = new Division("/");
        String inputOperation = op.getOperator();
        ...
        // invoke
        double result = op.operation(input);
        Boolean operator = op.matches(inputOperation);
